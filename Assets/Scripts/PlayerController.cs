...
namespace Bdiebeak.TPC
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        [Range(0, 1)] public float armsWeight = 1f;
        ...
        public GameObject mainPlayerCollider;
        public GameObject jumpingPlayerCollider;
        public LayerMask checkingLayers;
        public float checkDistance = 1f;
        public float delayBeforeCheck = 1f;

        [Header("Параметры для замедления времени при прыжке")]
        [Range(0, 1)] public float slowedTime;

        public PostProcessVolume mainPPVolume;
        public PostProcessProfile mainPPProfile;
        public PostProcessProfile slowtimePPProfile;
        ...
        private bool handsAreRaised;
        private bool isGrounded = true;
        private bool isStanding = true;
        private bool isTryingToStand;

        private float currentTimeForRisingHands;
        private float currentArmsWeight;
        private float neededTimeForGroundCheck;
